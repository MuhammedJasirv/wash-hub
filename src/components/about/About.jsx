  ...
  return (
    ...
    <section className="about">
      <div className="about-content">
        ...
        <p>
          Running a laundry business can be complex. From managing orders to scheduling pickups,
          keeping track of inventory, and handling requests
        </p>
        ...
        <div className="about-point">
          <h3>Provide Transforming Visions into Digital</h3>
          <p>
            Running a laundry business can be complex. From managing scheduling pickups, keeping
            track of inventory, and handling requests
          </p>
        </div>
      </div>
